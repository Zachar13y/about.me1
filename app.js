...
const countries = ['canada', 'mexico', 'england', 'france', 'germany', 'italy', 'the netherlands', 'luxembourg', 'belgium', 'austria'];
    ...
    let beenCountries = prompt('I\'ve been to 13 countries other than the U.S. You only get 5 guesses to guess one of them.').toLowerCase();

    while ( !countries.includes(beenCountries)){
        beenCountries = prompt('Nope! Guess again.')
